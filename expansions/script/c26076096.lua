--Lusamine (Crimson Invasion 96/111)
...
function scard.thfilter(c)
	return (c:IsSupporter() or c:IsStadium()) and c:IsAbleToHand()
end
...
function scard.thop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,scard.thfilter,tp,PM_LOCATION_DPILE,0,2,2,nil)

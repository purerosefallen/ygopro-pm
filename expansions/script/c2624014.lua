...
function scard.initial_effect(c)
	...
	pm.EnableEvolve(c)
	--discard energy
	pm.EnablePokemonAttack(c,0,PM_CATEGORY_COIN,pm.econ1(CARD_WATER_ENERGY,1),pm.hinttg,scard.deop)
	--damage
	pm.EnablePokemonAttack(c,1,nil,pm.econ2(CARD_WATER_ENERGY,2,CARD_COLORLESS_ENERGY,1),pm.hinttg,scard.damop)
end

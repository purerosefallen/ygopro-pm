...
function scard.atop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g2=Duel.GetMatchingGroup(scard.cfilter1,tp,PM_LOCATION_IN_PLAY,0,nil)
	if g1:GetCount()==0 or g2:GetCount()==0 then return end
	local ct=Duel.GetMatchingGroupCount(scard.cfilter1,tp,0,PM_LOCATION_IN_PLAY,nil)
	repeat

...
function scard.initial_effect(c)
	...
	--damage
	pm.EnablePokemonAttack(c,0,nil,pm.econ1(CARD_FIRE_ENERGY,1),pm.hinttg,scard.damop1)
	--damage
	pm.EnablePokemonAttack(c,1,nil,pm.econ2(CARD_FIRE_ENERGY,1,CARD_COLORLESS_ENERGY,1),pm.hinttg,scard.damop2)
end

...
function scard.thfilter1(c)
	return c:IsPokemon() and c:IsPokemonType(PM_ENERGY_FIGHTING) and c:IsAbleToHand()
end
...
function scard.thop(e,tp,eg,ep,ev,re,r,rp)
	...
	if g1:GetCount()==0 and g2:GetCount()==0 then return pm.SearchFailed(tp,tp) end
	g1:Merge(g2)

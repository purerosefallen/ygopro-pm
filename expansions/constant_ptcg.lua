...
CARD_PRIMAL_KYOGRE_EX				=26063055	--Kyogre-EX → Primal Kyogre-EX (Primal Clash 54/160)
...
PM_EFFECT_DONOT_END_TURN_MEGA		=730	--"Gengar Spirit Link" (Phantom Forces 95/119)
PM_EFFECT_EXTEND_BENCH_8			=731	--"Sky Field" (Roaring Skies 89/108)
PM_EFFECT_DOUBLE_POKEMON_TOOL		=732	--"Gyarados" (Black Star Promo XY60)
PM_EFFECT_DAMAGE_ATTACK_REDUCE_20	=733	--"Chesnaught" (BREAKthrough 11/162)
PM_EFFECT_DAMAGE_ATTACK_REDUCE_30	=734	--"Mewtwo-EX" (BREAKthrough 61/162)
PM_EFFECT_ASLEEP_TOSS_2_COIN		=735	--"Darkrai Prism Star" (Ultra Prism 77/156)

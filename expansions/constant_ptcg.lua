...
PM_HINTMSG_ADDDAMAGE				=aux.Stringid(PM_STRING_HINTMSG8,4)		--"Select a Pokémon to put a damage counter on."
PM_HINTMSG_REMOVEDAMAGE				=aux.Stringid(PM_STRING_HINTMSG8,5)		--"Select a Pokémon to remove a damage counter from."
PM_HINTMSG_MOVEDAMAGE				=aux.Stringid(PM_STRING_HINTMSG8,6)		--"Select a Pokémon to move the damage counter to."

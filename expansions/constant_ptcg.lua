...
PM_HINTMSG_TOBENCH					=aux.Stringid(PM_STRING_HINTMSG8,6)		--"Select a Pokémon to put onto the Bench."
PM_HINTMSG_DISCARD					=aux.Stringid(PM_STRING_HINTMSG8,7)		--"Select a card to discard."
PM_HINTMSG_TODECK					=aux.Stringid(PM_STRING_HINTMSG8,8)		--"Select a card to shuffle into the deck."
PM_HINTMSG_TODECKTOP				=aux.Stringid(PM_STRING_HINTMSG8,9)		--"Select a card to put on top of the deck."
PM_HINTMSG_TODECKBOT				=aux.Stringid(PM_STRING_HINTMSG8,10)	--"Select a card to put on the bottom of the deck."
PM_HINTMSG_TODISCARD				=aux.Stringid(PM_STRING_HINTMSG8,11)	--"Select a card to put into the discard pile."

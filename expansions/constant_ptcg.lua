...
PM_EFFECT_NO_RETREAT_COST			=715	--YGOPro cannot change RC to 0 ("Balloon Berry" Neo Revelation 60/64)
PM_EFFECT_RETREAT_COST_REPLACE		=716	--"Balloon Berry" (Neo Revelation 60/64)
...
PM_EFFECT_EXTRA_PRIZE_KNOCKED_OUT	=723	--"Rayquaza & Deoxys LEGEND" (Undaunted 89/90)
PM_EFFECT_CANNOT_ATTACK				=724	--"Haxorus" (Noble Victories 88/101)
PM_EFFECT_EXTEND_BENCH_8			=725	--"Sky Field" (Roaring Skies 89/108)
PM_EFFECT_DAMAGE_ATTACK_REDUCE_20	=726	--"Chesnaught" (BREAKthrough 11/162)
PM_EFFECT_DAMAGE_ATTACK_REDUCE_30	=727	--"Mewtwo-EX" (BREAKthrough 61/162)
PM_EFFECT_ASLEEP_TOSS_2_COIN		=728	--"Darkrai Prism Star" (Ultra Prism 77/156)

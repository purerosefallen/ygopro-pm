...
PM_EFFECT_RESTRICT_MIRACLE_ENERGY	=717	--"Miracle Energy" (Neo Destiny 16/105)
PM_EFFECT_RESTRICT_POKEMON_STAR		=718	--"Mudkip Star" (EX Team Rocket Returns 107/109)
PM_EFFECT_IMMUNE_DAMAGE				=719	--"Squirtle" (Base Set 63/102)
PM_EFFECT_IMMUNE_ATTACK				=720	--"Arceus" (Arceus AR9)
PM_EFFECT_IMMUNE_ATTACK_EFFECT		=721	--"Arceus" (Arceus AR9)

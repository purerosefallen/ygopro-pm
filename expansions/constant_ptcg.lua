...
CARD_MUDKIP							=26016059	--Mudkip → Marshtomp → Swampert (Ruby & Sapphire 59/109)
CARD_MARSHTOMP						=26016040	--Mudkip → Marshtomp → Swampert (Ruby & Sapphire 40/109)
CARD_SWAMPERT						=26016013	--Mudkip → Marshtomp → Swampert (Ruby & Sapphire 13/109)
CARD_TORCHIC						=26016073	--Torchic → Combusken → Blaziken (Ruby & Sapphire 73/109)
CARD_COMBUSKEN						=26016027	--Torchic → Combusken → Blaziken (Ruby & Sapphire 27/109)
CARD_BLAZIKEN						=26016003	--Torchic → Combusken → Blaziken (Ruby & Sapphire 3/109)
CARD_TREECKO						=26016075	--Treecko → Grovyle → Sceptile (Ruby & Sapphire 75/109)
CARD_GROVYLE						=26016031	--Treecko → Grovyle → Sceptile (Ruby & Sapphire 31/109)
CARD_SCEPTILE						=26016011	--Treecko → Grovyle → Sceptile (Ruby & Sapphire 11/109)
...
PM_HINTMSG_TOBENCH					=aux.Stringid(PM_STRING_HINTMSG8,8)		--"Select a Pokémon to put onto the Bench."
PM_HINTMSG_DISCARD					=aux.Stringid(PM_STRING_HINTMSG8,9)		--"Select a card to discard."
PM_HINTMSG_TODECK					=aux.Stringid(PM_STRING_HINTMSG8,10)	--"Select a card to shuffle into the deck."
PM_HINTMSG_TODECKTOP				=aux.Stringid(PM_STRING_HINTMSG8,11)	--"Select a card to put on top of the deck."
PM_HINTMSG_TODECKBOT				=aux.Stringid(PM_STRING_HINTMSG8,12)	--"Select a card to put on the bottom of the deck."
PM_HINTMSG_TODISCARD				=aux.Stringid(PM_STRING_HINTMSG8,13)	--"Select a card to put into the discard pile."

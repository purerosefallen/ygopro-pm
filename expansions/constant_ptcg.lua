...
PM_EFFECT_CANNOT_REMOVE_ENERGY_ATTACK_TRAINER	=714	--"Brock's Protection" (Gym Challenge 101/132)
PM_EFFECT_CANNOT_BE_ATTACKED		=715	--"Cyndaquil" (Neo Genesis 56/111)
PM_EFFECT_NO_RETREAT_COST			=716	--YGOPro cannot change RC to 0 ("Balloon Berry" Neo Revelation 60/64)
PM_EFFECT_RETREAT_COST_REPLACE		=717	--"Balloon Berry" (Neo Revelation 60/64)
PM_EFFECT_CANNOT_USE_POKEPOWER		=718	--"Gardevoir ex" (EX Dragon Frontiers 93/101)
PM_EFFECT_CANNOT_USE_POKEBODY		=719	--"Gardevoir ex" (EX Dragon Frontiers 93/101)
PM_EFFECT_IMMUNE_DAMAGE				=720	--"Squirtle" (Base Set 63/102)
PM_EFFECT_IMMUNE_ATTACK				=721	--"Arceus" (Arceus AR9)
PM_EFFECT_IMMUNE_ATTACK_EFFECT		=722	--"Arceus" (Arceus AR9)
PM_EFFECT_IMMUNE_ATTACK_DAMAGE		=723	--"Arceus" (Arceus AR9)
PM_EFFECT_IMMUNE_ATTACK_POKEMONLVX	=724	--"Arceus" (Arceus AR9)
PM_EFFECT_IMMUNE_ATTACK_NONEVOLVED	=725	--"Mewtwo LV.X" (Legends Awakened 144/146)
PM_EFFECT_EXTRA_PRIZE_KNOCKED_OUT	=726	--"Rayquaza & Deoxys LEGEND" (Undaunted 89/90)

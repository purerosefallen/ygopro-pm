...
PM_STRING_HINTMSG8					=26000012	--Hint Message
PM_STRING_HINTMSG9					=26000013	--Hint Message
...
CARD_MAGNEMITE						=26001053	--Magnemite → Magneton → Magnezone (Base Set 53/102)
CARD_MAGNETON						=26001009	--Magnemite → Magneton → Magnezone (Base Set 9/102)
CARD_MAGNEZONE						=26032008	--Magnemite → Magneton → Magnezone (Diamond & Pearl 8/130)
...
CARD_CYNDAQUIL						=26008056	--Cyndaquil → Quilava → Typhlosion (Neo Genesis 56/111)
CARD_QUILAVA						=26008046	--Cyndaquil → Quilava → Typhlosion (Neo Genesis 46/111)
CARD_TYPHLOSION						=26008017	--Cyndaquil → Quilava → Typhlosion (Neo Genesis 17/111)
...
CARD_CLEFABLE						=26002001	--Cleffa → Clefairy → Clefable (Jungle 1/64)
CARD_MAREEP							=26008065	--Mareep → Flaaffy → Ampharos (Neo Genesis 65/111)
CARD_FLAAFFY						=26008034	--Mareep → Flaaffy → Ampharos (Neo Genesis 34/111)
CARD_AMPHAROS						=26008001	--Mareep → Flaaffy → Ampharos (Neo Genesis 1/111)
CARD_NATU							=26008067	--Natu → Xatu (Neo Genesis 67/111)
CARD_XATU							=26008052	--Natu → Xatu (Neo Genesis 52/111)
...
CARD_SLOWPOKE						=26003055	--Slowpoke → Slowbro (Fossil 55/62)
CARD_SLOWBRO						=26003043	--Slowpoke → Slowbro (Fossil 43/62)
...
CARD_BROCKS_SANDSHREW				=26006071	--Brock's Sandshrew → Brock's Sandslash (Gym Heroes 71/132)
CARD_BROCKS_SANDSLASH				=26006023	--Brock's Sandshrew → Brock's Sandslash (Gym Heroes 23/132)
CARD_SNUBBULL						=26008074	--Snubbull → Granbull (Neo Genesis 74/111)
CARD_GRANBULL						=26008037	--Snubbull → Granbull (Neo Genesis 37/111)
CARD_LARVITAR						=26009057	--Larvitar → Pupitar → Tyranitar/Tyranitar ex (Neo Discovery 57/75)
CARD_PUPITAR						=26009045	--Larvitar → Pupitar → Tyranitar/Tyranitar ex (Neo Discovery 45/75)
CARD_TYRANITAR						=26009012	--Larvitar → Pupitar → Tyranitar/Tyranitar ex (Neo Discovery 12/75)
CARD_TYRANITAR_EX_OLD				=2605017	--Larvitar → Pupitar → Tyranitar/Tyranitar ex (POP Series 1 17/17)
CARD_NOSEPASS						=26016018	--Nosepass → Probopass (EX Ruby & Sapphire 18/109)
CARD_PROBOPASS						=26037013	--Nosepass → Probopass (Legends Awakened 13/146)
CARD_MUDKIP							=26016059	--Mudkip → Marshtomp → Swampert (EX Ruby & Sapphire 59/109)
CARD_MARSHTOMP						=26016040	--Mudkip → Marshtomp → Swampert (EX Ruby & Sapphire 40/109)
CARD_SWAMPERT						=26016013	--Mudkip → Marshtomp → Swampert (EX Ruby & Sapphire 13/109)
CARD_RALTS							=26016066	--Ralts → Kirlia → Gardevoir/Gardevoir ex (EX Ruby & Sapphire 66/109)
CARD_KIRLIA							=26016034	--Ralts → Kirlia → Gardevoir/Gardevoir ex (EX Ruby & Sapphire 34/109)
CARD_GARDEVOIR						=26016007	--Ralts → Kirlia → Gardevoir/Gardevoir ex (EX Ruby & Sapphire 7/109)
CARD_GARDEVOIR_EX_OLD				=26017096	--Ralts → Kirlia → Gardevoir/Gardevoir ex (EX Sandstorm 96/100)
CARD_TORCHIC						=26016073	--Torchic → Combusken → Blaziken (EX Ruby & Sapphire 73/109)
CARD_COMBUSKEN						=26016027	--Torchic → Combusken → Blaziken (EX Ruby & Sapphire 27/109)
CARD_BLAZIKEN						=26016003	--Torchic → Combusken → Blaziken (EX Ruby & Sapphire 3/109)
CARD_TREECKO						=26016075	--Treecko → Grovyle → Sceptile (EX Ruby & Sapphire 75/109)
CARD_GROVYLE						=26016031	--Treecko → Grovyle → Sceptile (EX Ruby & Sapphire 31/109)
CARD_SCEPTILE						=26016011	--Treecko → Grovyle → Sceptile (EX Ruby & Sapphire 11/109)
...
CARD_MEWTWO_EX						=26051054	--Mewtwo-EX → M Mewtwo-EX (Next Destinies 54/99)
...
CARD_KYOGRE_EX						=26063054	--Kyogre-EX → Primal Kyogre-EX (Primal Clash 54/160)
CARD_PRIMAL_KYOGRE_EX				=26063055	--Kyogre-EX → Primal Kyogre-EX (Primal Clash 55/160)
...
--↑EVENT_CUSTOM
CARD_DARK_IVYSAUR					=2604006	--Duel.RaiseSingleEvent(card,EVENT_CUSTOM+PM_EVENT_RETREAT,e,0,0,0,0)
--Counters/Markers
...
PM_IMPRISON_MARKER					=0x1607		--"Tropius δ" (EX Dragon Frontiers 23/101)
PM_SHOCKWAVE_MARKER					=0x1608		--"Tropius δ" (EX Dragon Frontiers 23/101)
--Win Reason
...
PM_EFFECT_FLAG_POKEPOWER			=0x20000000					--Included on all Poké-Power abilities
PM_EFFECT_FLAG_GX_ATTACK			=0x40000000					--Included on all GX attacks
--Codes
...
PM_EFFECT_EXTRA_ATTACK				=EFFECT_EXTRA_ATTACK		--A Pokémon can attack more than once per turn
...
PM_EFFECT_DEVOLVED					=CARD_DEVOLUTION_SPRAY		--Check if a Pokémon is devolved
...
PM_EFFECT_IMMUNE_SPECIAL_CONDITION	=713	--"Mysterious Fossil" (Fossil 62/62)
PM_EFFECT_EVOLVE_TURN_PLAY			=714	--"Giovanni" (Gym Challenge 18/132)
PM_EFFECT_CANNOT_REMOVE_ENERGY_ATTACK_TRAINER	=715	--"Brock's Protection" (Gym Challenge 101/132)
PM_EFFECT_CANNOT_BE_ATTACKED		=716	--"Cyndaquil" (Neo Genesis 56/111)
PM_EFFECT_NO_RETREAT_COST			=717	--YGOPro cannot change RC to 0 ("Balloon Berry" Neo Revelation 60/64)
PM_EFFECT_RETREAT_COST_REPLACE		=718	--"Balloon Berry" (Neo Revelation 60/64)
PM_EFFECT_CANNOT_USE_POKEPOWER		=719	--"Gardevoir ex" (EX Dragon Frontiers 93/101)
PM_EFFECT_CANNOT_USE_POKEBODY		=720	--"Gardevoir ex" (EX Dragon Frontiers 93/101)
PM_EFFECT_IMMUNE_DAMAGE				=721	--"Squirtle" (Base Set 63/102)
PM_EFFECT_IMMUNE_ATTACK				=722	--"Arceus" (Arceus AR9)
PM_EFFECT_IMMUNE_ATTACK_EFFECT		=723	--"Arceus" (Arceus AR9)
PM_EFFECT_IMMUNE_ATTACK_DAMAGE		=724	--"Arceus" (Arceus AR9)
PM_EFFECT_IMMUNE_ATTACK_POKEMONLVX	=725	--"Arceus" (Arceus AR9)
...
PM_EFFECT_DOUBLE_SUPPORTER			=729	--"Magnezone" (Plasma Storm 46/135)
PM_EFFECT_IGNORE_ENERGY				=730	--"Victory Piece" (Plasma Storm 130/135)
PM_EFFECT_DONOT_END_TURN_MEGA		=731	--"Gengar Spirit Link" (Phantom Forces 95/119)
PM_EFFECT_EXTEND_BENCH_8			=732	--"Sky Field" (Roaring Skies 89/108)
PM_EFFECT_DOUBLE_POKEMON_TOOL		=733	--"Gyarados" (Black Star Promo XY60)
PM_EFFECT_DAMAGE_ATTACK_REDUCE_20	=734	--"Chesnaught" (BREAKthrough 11/162)
PM_EFFECT_DAMAGE_ATTACK_REDUCE_30	=735	--"Mewtwo-EX" (BREAKthrough 61/162)
PM_EFFECT_ASLEEP_TOSS_2_COIN		=736	--"Darkrai Prism Star" (Ultra Prism 77/156)
...
PM_EVENT_RETREAT					=CARD_DARK_IVYSAUR		--When a Pokémon retreats
PM_EVENT_ATTACH_ENERGY_FROM_HAND	=CARD_PRIMAL_KYOGRE_EX	--When a player attaches an Energy card from their hand to a Pokémon
--Categories
...
PM_DESC_INVALID_POKEMON				=aux.Stringid(PM_STRING_DECK,1)			--"You can't have any non-Pokémon cards in your deck! Click OK to continue."
...
PM_DESC_EVOLVE						=aux.Stringid(PM_STRING_DESC,1)			--"Evolve"
PM_DESC_LVX							=aux.Stringid(PM_STRING_DESC,2)			--"Level Up"
...
PM_HINTMSG_MOVEENERGYFROM			=aux.Stringid(PM_STRING_HINTMSG7,10)	--"Select a Pokémon to move Energy from."
PM_HINTMSG_MOVEENERGY				=aux.Stringid(PM_STRING_HINTMSG7,11)	--"Select a Pokémon to move the Energy to."
PM_HINTMSG_ATTACHTOOL				=aux.Stringid(PM_STRING_HINTMSG7,12)	--"Select a Pokémon to attach the Pokémon Tool to."
PM_HINTMSG_DISCARDTOOLFROM			=aux.Stringid(PM_STRING_HINTMSG7,13)	--"Select a Pokémon to discard a Pokémon Tool from."
PM_HINTMSG_DISCARDTOOL				=aux.Stringid(PM_STRING_HINTMSG7,14)	--"Select a Pokémon Tool to discard."
PM_HINTMSG_MOVETOOL					=aux.Stringid(PM_STRING_HINTMSG7,15)	--"Select a Pokémon to move the Pokémon Tool to."
PM_HINTMSG_ENERGYTYPE				=aux.Stringid(PM_STRING_HINTMSG8,0)		--"Choose a type."
PM_HINTMSG_TOHAND					=aux.Stringid(PM_STRING_HINTMSG8,1)		--"Select a card to put into your hand."
PM_HINTMSG_HEAL						=aux.Stringid(PM_STRING_HINTMSG8,2)		--"Select a Pokémon to heal."
PM_HINTMSG_DAMAGE					=aux.Stringid(PM_STRING_HINTMSG8,3)		--"Select a Pokémon to damage."
PM_HINTMSG_ADDDAMAGE				=aux.Stringid(PM_STRING_HINTMSG8,4)		--"Select a Pokémon to put a damage counter(s) on."
PM_HINTMSG_REMOVEDAMAGE				=aux.Stringid(PM_STRING_HINTMSG8,5)		--"Select a Pokémon to remove a damage counter(s) from."
PM_HINTMSG_MOVEDAMAGE				=aux.Stringid(PM_STRING_HINTMSG8,6)		--"Select a Pokémon to move the damage counter(s) to."
PM_HINTMSG_NUMBERDAMAGE				=aux.Stringid(PM_STRING_HINTMSG8,7)		--"Remove how many damage counters?"
PM_HINTMSG_NUMBERDRAW				=aux.Stringid(PM_STRING_HINTMSG8,8)		--"Draw how many cards?"
PM_HINTMSG_TOBENCH					=aux.Stringid(PM_STRING_HINTMSG8,9)		--"Select a Pokémon to put onto the Bench."
PM_HINTMSG_DISCARD					=aux.Stringid(PM_STRING_HINTMSG8,10)	--"Select a card to discard."
PM_HINTMSG_TODECK					=aux.Stringid(PM_STRING_HINTMSG8,11)	--"Select a card to shuffle into the deck."
...
PM_HINTMSG_KNOCKOUT					=aux.Stringid(PM_STRING_HINTMSG9,0)		--"Select a Pokémon to Knock Out."
